...
Em comum a todos os kernel, variou-se o parâmetro C do SVM utilizado para penalizar os valores
mal classificados, variando-o entre $10^-3$ a $10^2$. Já para o RBF, varia-se o parâmetro $\gamma$
com valores entre $10^-4$ e $10^4$. Por último para o polinomial, varia-se tanto o parâmetro d
que determina o grau do polinômio (aqui variamos entre 3, 4 e 5) e o coeficiente que variamos
entre 0 a $10^2$.
...
baixo erro no conjunto de treino, porém baixa generalização. Este parâmetro será variado de 
$10^-3$ a $10^2$ também. Importante ressaltar que $\lambda$ só é aplicado nos índices
...
\begin{itemize}
	...
	\item Recall: taxa calculada pela expressão $\frac{tp}{tp + fn}$ onde tp corresponde
	...
	1, melhor.
	\item Medida F: pode ser interpretado como uma média harmônica entre precisão e recall é dado
	pela expressão: $2*\frac{precis*recall}{precis + recall}$. Assim como as demais medidas, quanto
