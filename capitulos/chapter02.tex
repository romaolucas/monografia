...
linear, isto é, a menor distância de um ponto ao hiperplano.

Deduzir aqui a função objetivo original

Iremos supor que não necessariamente nossa entrada não é linearmente separável, 
...
será necessário suavizarmos nossa margem através da introdução de variáveis


Nossa função objetivo então é 

\begin{center}
	\begin{equation}
		C\sum_{i = 1}^n\xi_i + \frac{1}{2}||w||^2
	\end{equation}
\end{center}