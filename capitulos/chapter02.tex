...
\begin{tikzpicture}
\draw[step=1cm,light-gray,very thin] (-2,-2) grid (6,6);
\draw[thick,->] (-2,-2) -- (5.5,-2) node[anchor=north west] {$x_1$};
\draw[thick,->] (-2,-2) -- (-2,5.5) node[anchor=south east] {$x_2$};

% classe 1
\draw (0, 0) node[cross, blue] {};
\draw (0, .5) node[cross, blue] {};
\draw (.5, 0) node[cross, blue] {};
\draw (1.5, .5) node[cross, blue] {};
\draw (.5, 1.5) node[cross, blue] {};

% classe 2
\draw[line width=.5mm, green] (3,0) circle (1ex);
\draw[line width=.5mm, green] (3,3) circle (1ex);
\draw[line width=.5mm, green] (3.5,0) circle (1ex);
\draw[line width=.5mm, green] (3.5,3.5) circle (1ex);
\draw[line width=.5mm, green] (2,3) circle (1ex);
\end{tikzpicture}